...
if [ ! -z $1 ]; then
  ...
  gcovr --json-summary-pretty --json-summary --root /app/$1/src --object-directory /app/$1/build/ -o $2/coverage_$1.json
  echo "The coverage report can be found here: $2/coverage_$1.json"
else
  help
  exit 1
fi
